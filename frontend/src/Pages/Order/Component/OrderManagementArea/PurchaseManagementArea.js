...
import PurchaseOrderTableData from "./Component/OrderTableData/PurchaseOrderTableData";
...
function PurchaseManageMentArea({
  posts,
  setPosts,
  currentPosts,
  loading,
  ...
  useEffect(() => {
    axios
      ...
      .then((res) =>
        setTableHead(res.data.data.order_table_data[3].purchase_header)
      );
  }, []);
...
export default PurchaseManageMentArea;
